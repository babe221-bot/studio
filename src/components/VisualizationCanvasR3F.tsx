...
const VisualizationCanvasR3F = forwardRef<CanvasHandle, VisualizationProps>(
...
VisualizationCanvasR3F.displayName = 'VisualizationCanvasR3F';

export default VisualizationCanvasR3F;
