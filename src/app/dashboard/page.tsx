...
export default function DashboardPage() {
  const { versions, templates, deleteVersion, deleteTemplate } =
    useProjectHistory();
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Pregledajte vaše spremljene projekte i predloške
          </p>
        </div>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Vaše spremljene točke u vremenu. Kliknite na "Lab" za povratak i
                nastavak rada.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="templates">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Spremljene konfiguracije koje možete ponovno koristiti kao bazu
                za nove projekte.
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {templates.map((template) => (
                      <Card key={template.id} className="overflow-hidden">
                        <CardHeader className="pb-3">
                          ...
                          <CardDescription>
                            Kreirano{' '}
                            {format(template.createdAt, 'PP', { locale: hr })}
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          <div className="text-sm text-muted-foreground mb-4 line-clamp-2 min-h-[2.5rem]">
